"""
Canonical linear programming problem representation.

This module defines the standard form for linear programming problems,
useful for portfolio optimization with linear objectives (e.g., max return).
"""
...
class LPProblem:
    ...
    Attributes:
        c: (n,) linear objective coefficient vector
    ...
    For portfolio optimization:
        - c = -μ (maximize expected return → minimize -μ' w)
